...
def reflectance ( file, Temp='None', Bfunction='None'):
	...
	t0=get_t0(Temp) # Chamando a função get_t0                                               #
        ############################### MODIFICAÇÂO IMPLEMENTADA #################################
...
############################### MODIFICAÇÂO IMPLEMENTADA ##################################################################################
# Quarta função chamada dentro da função "reflectance" - Calcula t0 em funçao da temperatura                                              #
def get_t0(Temp):                                                                                                                         #
    t0 = 0.75 # Kaufman & Nakajima 1993                                                                                                   #
    # Redefining t0 according to cloud top temperature (calculated for GOES-13 channel 2)                                                 #
    t0=Temp                                                                                                                               #
    t0=-31.117548896 + 0.5608499782*Temp - 0.0036639395*np.power(Temp,2) + 1.0623749E-5*np.power(Temp,3) - 1.155964E-8*np.power(Temp,4)   #
    lotrans=Temp>300.0                                                                                                                    #
    hitrans=Temp<200.0                                                                                                                    #
    t0[lotrans]=0.6                                                                                                                       #
    t0[hitrans]=1.0                                                                                                                       #
